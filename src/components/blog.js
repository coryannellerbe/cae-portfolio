			...
			<div className="colorlib-narrow-content">
				...
				<div className="row">
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small>2.10.2020</small> | <small> Development </small> | <small> <i className="icon-bubble3" /> 4</small></span>
							<h3><a href="blog.html">Building a React Portfolio</a></h3>
							<p>The highs, the lows, and everything that made me say "huh?"</p>
						</div>
					</div>
					</div>
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small>April 14, 2020 </small> | <small> Web Development </small> | <small> <i className="icon-bubble3" /> 4</small></span>
